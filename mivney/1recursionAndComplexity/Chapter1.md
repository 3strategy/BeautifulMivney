...
הדרכה. חשבו על המקרה בו עלינו לכפול 4 ב-1 כעל המקרה הפשוט. זה ישמש תנאי עצירה
...
# 2) מנה של חלוקה שלמה בחיסור חוזר – דוגמה: \(\left\lfloor 9/4 \right\rfloor = 2\)
