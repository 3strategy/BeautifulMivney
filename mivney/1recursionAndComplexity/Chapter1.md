...
---
<details markdown="1">
<summary>הרחבת ידע – האם באמת משתמשים ברקורסיה בעולם האמיתי?</summary>

### כן. אבל לא בכל מקום

רקורסיה אינה "טובה יותר" מלולאה באופן כללי.
היתרון הגדול שלה מופיע כאשר **הבעיה או מבנה הנתונים עצמם בנויים בצורה רקורסיבית** – כלומר, דבר שמכיל דברים נוספים מאותו סוג.

הדוגמה החשובה ביותר שנפגוש בהמשך היא **עץ בינארי**:
...
כל צומת מכיל שני עצים קטנים יותר: עץ שמאלי ועץ ימני.

לכן פעולה על עץ נכתבת באופן טבעי מאוד כך:
...
הרעיון הוא בדיוק הרעיון שלמדנו:

**פתור את המקרה הנוכחי, ובקש משתי הקריאות הרקורסיביות לפתור את שתי הבעיות הקטנות יותר.**

---

### וזה קורה בתוכנות אמיתיות

**Git** שומר תיקיות וקבצים במבנה של עצים. בקוד של Git קיימת פעולה שסורקת עץ, וכאשר היא מגיעה לתת־עץ היא קוראת שוב לעצמה כדי לסרוק אותו.

מעניין במיוחד ש-Git גם מגביל את **עומק העץ המרבי**. כלומר, המפתחים משתמשים ברקורסיה – אבל לא נותנים לה לרדת לעומק בלתי מוגבל.

גם **Clang**, מהדר אמיתי של C ו-C++, משתמש במנגנון בשם `RecursiveASTVisitor` כדי לעבור על עץ התחביר (AST) של תוכנית.

גם בקוד של **Python עצמו (CPython)** קיימות פעולות רקורסיביות שעוברות על עצי תחביר, יחד עם מנגנונים שמגינים מפני עומק רקורסיה גדול מדי.

כלומר, רקורסיה אינה רק תרגיל לבגרות. היא נמצאת בתוכנות אמיתיות כאשר הנתונים עצמם בנויים כעץ או כמבנה מקונן.
...
המעבד **לא באמת מבצע כפל בצורה הזו באמצעות קריאות רקורסיביות**.

אבל יש כאן רעיון אמיתי מאוד מעולם החומרה:

> פעולה מסובכת יכולה להיבנות מרצף של פעולות פשוטות יותר.

אלגוריתמים לחילוק בינארי בחומרה מבצעים למשל שוב ושוב פעולות של **הזזה, חיסור ובדיקה של שארית חלקית**.

גם במעבדים היסטוריים של Intel נעשה שימוש באלגוריתם בשם **CORDIC**, שבו פעולות מתמטיות מורכבות מחושבות באמצעות סדרה של צעדים פשוטים החוזרים שוב ושוב.

בחומרה בדרך כלל קוראים לרעיון כזה **recurrence** – נוסחת נסיגה – ולא לרקורסיה של פונקציות, מפני שאין שם מחסנית קריאות כמו בתוכנית שלנו.

לכן `Mul` ו-`Div` שלנו אינם הדגם המדויק של יחידת הכפל והחילוק במעבד, אבל העיקרון של **הקטנת בעיה ובניית התוצאה באמצעות צעדים פשוטים חוזרים** הוא עיקרון אמיתי לחלוטין בעולם המחשבים.

---

### ואם זה כל כך שימושי, למה לפעמים אוסרים על רקורסיה?

דווקא מפני שלרקורסיה יש מחיר.

כל קריאה מוסיפה מידע למחסנית הקריאות. אם עומק הרקורסיה אינו צפוי, קשה לדעת מראש כמה זיכרון היא תצרוך.

לכן בתוכנה שבה תקלה עלולה להיות מסוכנת במיוחד, לפעמים מחליטים לא להשתמש בה כלל. לדוגמה, כללי תכנות מסוימים של **NASA/JPL לתוכנה קריטית** אוסרים על רקורסיה ישירה ועקיפה, כדי שאפשר יהיה להוכיח מראש גבולות לזמן הריצה ולשימוש במחסנית.

חשוב לדייק: **אין איסור כללי של ממשלת ארצות הברית על רקורסיה.** מדובר בכללי תכנות מחמירים שנועדו לסוגים מסוימים של תוכנה קריטית.

---

{: .box-success}
**המסקנה:** רקורסיה אינה משהו שצריך "להאמין בו", וגם לא משהו שצריך לפחד ממנו.
כאשר מבנה הבעיה רקורסיבי – למשל עצים, עצי תחביר או מבני תיקיות – היא יכולה להיות הדרך הישירה והברורה ביותר לכתוב את האלגוריתם. כאשר עומק הקריאות עלול להיות גדול או בלתי צפוי, צריך להגביל אותו או לבחור פתרון אחר.
