---
layout: page
title: "ex1a1 רקורסיה מספרית ובוליאנית"
subtitle: "קלט פלט חישובים"
tags: [עצרת, סכום ספרות, בדיקת זוגיות, בדיקת מונוטוניות עולה, בדיקת פלינרום, קיום סיפרה,סדרת פיבונאצ'י, בדיקה אם מספר הוא ראשוני]
mathjax: true
lang: he
---
...
## 1a1.1 חישוב עצרת באמצעות רקורסיה {#id1a1.1}
...
## 1a1.2 סכום ספרות מספר באמצעות רקורסיה {#id1a1.2}
...
## 1a1.3 בדיקת זוגיות מספר באמצעות רקורסיה {#id1a1.3}
...
## 1a1.4 פונקציה רקורסיבית לחישוב חזקה {#id1a1.4}
...
## 1a1.5 בדיקה רקורסיבית של סדר עולה בספרות {#id1a1.5}
...
## 1a1.6 בדיקת פלינדרום באמצעות רקורסיה {#id1a1.6}
...
## 1a1.7 בדיקת קיום ספרה במספר באמצעות רקורסיה {#id1a1.7}
...
## 1a1.8 חישוב המחלק המשותף הגדול באמצעות רקורסיה {#id1a1.8}
...
## 1a1.9 פעולה רקורסיבית לחישוב פיבונאצ'י {#id1a1.9}
...
## 1a1.10 בדיקת מספר ראשוני באמצעות רקורסיה {#id1a1.10}
