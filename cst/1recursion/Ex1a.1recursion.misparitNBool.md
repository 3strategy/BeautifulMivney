...
## 1a1.4 פונקציה רקורסיבית לחישוב חזקה
...
## 1a1.5 בדיקה רקורסיבית של סדר עולה בספרות
...
## 1a1.6 בדיקת פלינדרום באמצעות רקורסיה
...
## 1a1.7 בדיקת קיום ספרה במספר באמצעות רקורסיה
...
## 1a1.8 חישוב המחלק המשותף הגדול באמצעות רקורסיה
...
## 1a1.9 פעולה רקורסיבית לחישוב פיבונאצ'י
...
## 1a1.10 בדיקת מספר ראשוני באמצעות רקורסיה
