...
## 1a3.4 היפוך מערך באמצעות רקורסיה {#id1a3.4}
...
## 1a3.5 סכום איברי מערך רקורסיבי {#id1a3.5}
...
## 1a3.6 הדפסת מערך בסדר הפוך (רקורסיה) {#id1a3.6}
...
## 1a3.7 מיון מיזוג (Merge Sort) {#id1a3.7}
...
## 1a3.8 ספירת מספרים זוגיים במערך רקורסיבית {#id1a3.8}
...
## 1a3.9 האיבר הגדול ביותר במערך (רקורסיבי) {#id1a3.9}
...
## 1a3.10 בדיקת מערך ממוין רקורסיבית {#id1a3.10}
...
## 1a3.11 חיפוש איבר במערך רקורסיבי {#id1a3.11}
...
## 1a3.12 חיפוש רקורסיבי של איבר במערך לא ממויין {#id1a3.12}
עליכם לממש פונקציה רקורסיבית ב-C# בשם `SearchArray` עם החתימה הבאה:
