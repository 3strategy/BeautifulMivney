...
עליכם לממש פונקציה בשם `IsArielTree` אשר מקבלת BinNode⟨int⟩ tree המצביע לשורש של עץ בינארי
...
<!-- add question description here for `HasDifferentChildren` -->

## 6a2.6 בדיקת צומת ללא בנים שווים בעץ בינארי {#id6a2.6}

<!-- add question description here for `HasNoDifferentChildren` -->
...
## 6a2.10. בדיקת עץ מעיין {#id6a2.10.}
