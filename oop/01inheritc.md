...
### דוגמאות שגויות - ההבדל בין סוג של (הורשה), לבין הכלה ואגרגציה:
...
**◆** (מעוין מלא) - מציין קומפוזיציה/הכלה (Composition) - "Owns-a" חזק

**◇** (מעוין חלול) - מציין אגרגציה (Agregation) - "Shares-a" 
...
{: .box-success}
**מפתח להצלחה:** תרגול הוא המפתח להבנת הורשה. נסו ליצור היררכיות משלכם ולהתנסות בקוד!
