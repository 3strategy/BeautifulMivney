...
public class Beaver : Mammal
{
  ...
  {
    id: 3,
    title: "שאלה 3: cast שגוי מ-`Object` ל-`Beaver`",
    promptHe: "מה יקרה כאן?",
    codeLang: "csharp",
...
Console.WriteLine(b2.IsSame(b1));`,
  ...
  {
    id: 8,
    title: "שאלה 8: cast ל-`Antelope` מפעיל את ה-overload",
    promptHe: "מה יקרה כאן?",
    codeLang: "csharp",
  ...
  {
    id: 9,
    title: "שאלה 9: `Beaver` משווה רק ל-`Beaver`",
    promptHe: "מה יקרה כאן?",
    codeLang: "csharp",
