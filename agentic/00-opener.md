...
כל החומרים שאני בונה לסדנה זמינים כבר [כאן בתפריט Agentic Engineering](/agentic/00-opener)

**יש שם יותר ממה שנספיק:**

- פתיחה על ההבדל בין Chat רגיל לבין עבודה עם agent בתוך סביבת קוד,
- Git/GitHub, מפרטים ב-Markdown, AGENTS.md,
- Harness Engineering mindset & Agentic Workflows,
- עבודה עם clasp ו-Google Sheets / Apps Script,
- יצירת אתר תוכן Markdown/Jekyll בפרומפט אחד שיכול לשמש אותכם להוראה (כולל live hosting),
- אתר מלא עם Harness: live hosting, CI/CD, UnitTests, Playwright E2E, Firebase מהפרומפט הראשון,
- ואפילו התראות מ-Codex כשהוא מסיים לעבוד, לאלו שיצרו חשבון [pushbullet](https://www.pushbullet.com/){:target="_blank"}

**אשתדל לעבוד איתכם על שלושה *תוצרים* שימושיים לנו כמורים:**

1. clasp  ו-Google Apps Script. כל מי שמשתמש באקסל או בגוגל שיטס יכול להנות מהתועלת של app script. ואם כבר, אז agentic.
2. אתר Markdown/Jekyll שבו תוכלו ליצור תכניה הוראה הזמינים לתלמידים באתר (כמו אצלי למשל). יש שתי גרסאות - למתחילים ולמתקדמים שכבר עובדים עם wsl, npm וכו'.
3. התנסות ב- one shot prompt for a project+git with a **full harness**,(2nd and 3rd prompts for firebase & live deployment)
