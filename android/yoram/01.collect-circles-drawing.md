...
עברו אל
[CollectCircles 1א - בניית המסך בעזרת Layout Editor]({{ '/android/yoram/01a.collect-circles-layout-editor' | relative_url }}).
...
- [CollectCircles 2 - מצב משחק, עיגולים אקראיים וגרירה]({{ '/android/yoram/02.collect-circles-game' | relative_url }})
