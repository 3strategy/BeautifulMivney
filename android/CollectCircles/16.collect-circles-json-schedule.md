...
[הפרק הקודם]({{ '/android/CollectCircles/15.collect-circles-periodic-work' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/17.collect-circles-worker-settlement' | relative_url }}){: data-sequence-nav="next"}
...
[המשך לפרק 17: כתיבה בטוחה מן ה־Worker](/android/CollectCircles/17.collect-circles-worker-settlement){: data-sequence-nav="next"}
