...
2. ב־Android Studio פתחו **App Inspection → Background Task Inspector** ובחרו את process היישום.
3. חפשו שתי עבודות מחזוריות: `pusher_check_battery` ו־`pusher_check_charging`.
4. בדקו שלאחת מרווח של 3 שעות ו־Battery Not Low, ולשנייה 30 דקות ו־Charging.
5. סגרו ופתחו את ה־Activity שוב. מספר התוכניות צריך להישאר שתיים ולא לגדול.
6. לבדיקת ההתראה המיידית המשיכו להשתמש בכפתור **Check** מפרק 14; אין צורך להמתין למחזור אמיתי בכל שינוי קוד.
