...
[הפרק הקודם]({{ '/android/CollectCircles/14.collect-circles-first-worker' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/16.collect-circles-json-schedule' | relative_url }}){: data-sequence-nav="next"}
...
[המשך לפרק 16: מערכת שעות ב־JSON](/android/CollectCircles/16.collect-circles-json-schedule){: data-sequence-nav="next"}
