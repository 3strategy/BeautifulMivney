...
[חזרה לפרק 17: כתיבה בטוחה מן ה־Worker](/android/CollectCircles/17.collect-circles-worker-settlement){: data-sequence-nav="prev"}
...
בחלון **Android** צרו תחת `app > res > layout` את הקובץ `dialog_pusher_shop.xml`:
