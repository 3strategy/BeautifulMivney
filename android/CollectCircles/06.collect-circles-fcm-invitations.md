...
לפרויקט, יצרנו `firebase.properties` מקומי ובו ארבעה ערכי לקוח בלבד, שהמורה יספק לכם. הרעיון הוא שתוכלו להמשיך לעבוד עם קובץ הגדרות הפיירבייס שלכם, ובמקביל יפעל מנגנון התראות דרך שרת אחר, של המורה:
