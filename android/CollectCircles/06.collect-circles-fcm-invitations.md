...
[הפרק הקודם]({{ '/android/CollectCircles/05.collect-circles-local-notification' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/08.collect-circles-persistent-economy' | relative_url }}){: data-sequence-nav="next"}
...
- [המשך למדריך-8 (תלמיד): חיסכון שנשמר ונצבר](/android/CollectCircles/08.collect-circles-persistent-economy){: data-sequence-nav="next"}
