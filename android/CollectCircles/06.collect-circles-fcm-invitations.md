...
`Shift`). הקובץ נמצא לצד `settings.gradle.kts`. הוסיפו:
...
צרו בשורש הפרויקט, לצד `settings.gradle.kts`, קובץ חדש בשם:
...
- [המשך ל-6 (תלמיד): חיסכון שנשמר ונצבר](/android/CollectCircles/08.collect-circles-persistent-economy)
