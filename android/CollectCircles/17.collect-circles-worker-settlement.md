...
[הפרק הקודם]({{ '/android/CollectCircles/16.collect-circles-json-schedule' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/18.collect-circles-pusher-brag' | relative_url }}){: data-sequence-nav="next"}
...
[המשך לפרק 18: Brag לאחר קניית Pusher](/android/CollectCircles/18.collect-circles-pusher-brag){: data-sequence-nav="next"}
