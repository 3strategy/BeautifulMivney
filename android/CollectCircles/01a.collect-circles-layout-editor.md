...
[הפרק הקודם]({{ '/android/CollectCircles/01.collect-circles-drawing' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/02.collect-circles-game' | relative_url }}){: data-sequence-nav="next"}
