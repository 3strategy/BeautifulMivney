...
[הפרק הקודם]({{ '/android/CollectCircles/13.collect-circles-offline-progress' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/15b.collect-circles-notification-only' | relative_url }}){: data-sequence-nav="next"}
...
- [מסלול קצר וסיום — פרק 15b: התראה מחזורית ו־Brag](/android/CollectCircles/15b.collect-circles-notification-only){: data-sequence-nav="next"}
