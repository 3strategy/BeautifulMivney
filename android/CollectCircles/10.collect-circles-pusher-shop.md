...
[הפרק הקודם]({{ '/android/CollectCircles/09.collect-circles-autonomous-mode' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/11.collect-circles-draw-pusher' | relative_url }}){: data-sequence-nav="next"}
...
[המשך לפרק 11: מציירים Pusher הולך](/android/CollectCircles/11.collect-circles-draw-pusher){: data-sequence-nav="next"}
