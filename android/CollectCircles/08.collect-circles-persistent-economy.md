...
[הפרק הקודם]({{ '/android/CollectCircles/06.collect-circles-fcm-invitations' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/09.collect-circles-autonomous-mode' | relative_url }}){: data-sequence-nav="next"}

במסך מגע אפשר להחליק ימינה לפרק הבא ושמאלה לפרק הקודם. התחילו את המחווה בתוך אזור הטקסט, הרחק מקצות המסך ששמורים למחוות המערכת, ולא בתוך קטע קוד או טבלה שנגללים אופקית.
...
[המשך לפרק 9: מצב משחק אוטונומי](/android/CollectCircles/09.collect-circles-autonomous-mode){: data-sequence-nav="next"}
