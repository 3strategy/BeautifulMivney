...
[הפרק הקודם]({{ '/android/CollectCircles/12.collect-circles-pushers-work' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/14.collect-circles-first-worker' | relative_url }}){: data-sequence-nav="next"}
...
[המשך לפרק 14: בדיקת זכאות ראשונה עם WorkManager](/android/CollectCircles/14.collect-circles-first-worker){: data-sequence-nav="next"}
