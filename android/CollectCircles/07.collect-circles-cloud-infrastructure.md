...
This chapter is for the teacher or student who owns the Firebase project. A student who only runs the Android exercise
does not need cloud permissions, Firebase CLI, or any server credential.

## Goal and trust boundary

The Android app must never contain an Admin SDK credential. Its Firebase application ID and API key identify the client;
they do not grant permission to send an FCM message. Only the Cloud Function runs with the dedicated cloud identity that
...
The paths below use the teacher's checkout root:
...
These files from the current Android change belong in the teaching repository:

```text
C:\Users\3stra\AndroidStudioProjects\CollectCircles\.gitignore
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\build.gradle.kts
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\AndroidManifest.xml
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\java\com\example\collectcircles\MainActivity.java
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\java\com\example\collectcircles\CircleMessagingService.java
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\res\layout\activity_main.xml
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\res\values\strings.xml
C:\Users\3stra\AndroidStudioProjects\CollectCircles\gradle\libs.versions.toml
C:\Users\3stra\AndroidStudioProjects\CollectCircles\firebase.properties.example
```

The repository must also already contain the chapter 5 implementation, especially:

```text
C:\Users\3stra\AndroidStudioProjects\CollectCircles\app\src\main\java\com\example\collectcircles\Notifications.java
```

The teacher privately supplies one local file containing the four Firebase client values:

```text
C:\Users\3stra\AndroidStudioProjects\CollectCircles\firebase.properties
```
