...
[הפרק הקודם]({{ '/android/CollectCircles/06.collect-circles-fcm-invitations' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/08-18.student-roadmap' | relative_url }}){: data-sequence-nav="next"}
...
- [Student roadmap for chapters 8–18: from a short game to an Idle game](/android/CollectCircles/08-18.student-roadmap){: data-sequence-nav="next"}
