...
[הפרק הקודם]({{ '/android/CollectCircles/03.collect-circles-finish' | relative_url }}){: data-sequence-nav="prev"} · [הפרק הבא]({{ '/android/CollectCircles/05.collect-circles-local-notification' | relative_url }}){: data-sequence-nav="next"}
...
[קישור למדריך 5: Notification](/android/CollectCircles/05.collect-circles-local-notification){: data-sequence-nav="next"}
