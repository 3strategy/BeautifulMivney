...
3. Replace navigation with the typed two-table INNER JOIN while preserving the visible result.
4. Add all three insert dialogs, final Javadocs, and verification.

Optional extension: replace only the result TextView with RecyclerView after the four-step database lesson works.
