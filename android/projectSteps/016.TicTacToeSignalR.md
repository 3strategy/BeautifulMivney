...
[חזרה ל־015b: חיבור מסך המשחק למודל](/android/projectSteps/015b.AddingTicTacToeToMainActivity){: data-sequence-nav="prev"}
...
- [017 - שכפול Activity והכנת מסלול RTDB](/android/projectSteps/017DuplicateAndAddActivityToMenu){: data-sequence-nav="next"}
