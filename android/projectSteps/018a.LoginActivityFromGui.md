...
[Back to 017: prepare Main2Activity for the RTDB track](/android/projectSteps/017DuplicateAndAddActivityToMenu){: data-sequence-nav="prev"}
...
- [018b - connect the project to Firebase and enable Authentication](/android/projectSteps/018b.FirebaseProjectRtdbAuthSetup){: data-sequence-nav="next"}
