...
[Back to 018a: create the LoginActivity shell](/android/projectSteps/018a.LoginActivityFromGui){: data-sequence-nav="prev"}
...
- [018c - Email/Password login and FBRef](/android/projectSteps/018c.EmailPasswordLoginAndFBRef){: data-sequence-nav="next"}
- [018c alternative - Hebrew instructions with View Binding](/android/projectSteps/018c.EmailPasswordLoginAndFBRefHebrewBindings)
