...
[Back to 015a: create TicTacToeModel](/android/projectSteps/015a.creatingTicTacToeModel){: data-sequence-nav="prev"}
...
<details markdown="1" class="hebrew"><summary>כיצד תשעה כפתורים מגיעים למתודה אחת?</summary>
...
- [016 - connect Tic-Tac-Toe through SignalR](/android/projectSteps/016.TicTacToeSignalR){: data-sequence-nav="next"}
