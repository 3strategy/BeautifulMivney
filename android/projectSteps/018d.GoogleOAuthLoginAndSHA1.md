...
{: .box-note}
Detailed SHA1 command and screenshots are still documented later in Step `6` and Step `7`.
...
## Step 6 - Critical SHA1 step (when runtime Google login fails)
...
## Step 7 - Where to add this SHA1 in Firebase
...
## Step 8 - Runtime validation checklist (Google Sign-In)
