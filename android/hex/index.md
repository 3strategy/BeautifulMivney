...
| [09 — ערכות נושא ליום וללילה]({{ '/android/hex/09-day-night-themes/' | relative_url }}) | `values-night`, משאבי צבע וערכת Material 3 | צבעי המסך, הלוח והפקדים מתאימים את עצמם להגדרת התצוגה של המכשיר. |
