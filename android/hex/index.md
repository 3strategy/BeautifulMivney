...
בפרקים **01–04** נגיע למשחק מקומי שלם; בפרקים **05–07** נחבר אליו את המחשב ונבחר בין מודלים מסופקים; בפרק **08** נתאים את מראה אותו מסך ליום וללילה. המהלך שנבחר מוחל על המשחק, והתור חוזר לאדם אם המשחק עדיין לא הסתיים.
...
flowchart TB
    ...
    activity -->|"בקשת מהלך ברקע"| ai["HexAi<br/>בחירה בין מהלכים חוקיים"]
