...
| בדיקות של Android והתנהגות משולבת | **נלמד, ראוי להעמקה** | מעבר מ־unit tests לפונקציות טהורות ל־instrumented/UI tests; תרגילי regression למחזור חיים, persistence, הרשאות, offline ו־migration | [בדיקת מחיר](/android/CollectCircles/10.collect-circles-pusher-shop), [בדיקת מודלים ב־Hex](/android/hex/06-supplied-rl-models/), [בדיקת מחשבון אופליין](/android/CollectCircles/13.collect-circles-offline-progress) |
...
| אסינכרוניות ותחרות בין פעולות | **נלמד, ראוי להעמקה** | Connect4 מוסיף Executor/main thread, ביטול וזהות בקשה, transactions ותוצאה ישנה. להעמקה: תרגילי כשל עצמאיים וניתוח תחרות בפרויקט חדש | [מחשב ברקע ב־Connect4](/android/Connect4/06.connect4-background-turns/), [מחשב ברקע ב־Hex](/android/hex/05-background-ai/), [מהלכים מקבילים](/android/Connect4/11.connect4-online-game/), [התאוששות](/android/Connect4/12.connect4-online-recovery/) |
