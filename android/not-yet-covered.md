...
| ארכיטקטורת state: ViewModel, Repository וזרימת מידע חד־כיוונית | **נלמד, ראוי להעמקה** | Connect4 מלמד session ב־ViewModel, snapshots ו־Repository; נדרשים עדיין תרגילי העברה לפרויקט אחר, observable state והפרדת אחריות רחבה יותר | [שמירה](/android/Connect4/04.connect4-save-and-restore/), [התאוששות](/android/Connect4/12.connect4-online-recovery/) |
...
| אסינכרוניות ותחרות בין פעולות | **נלמד, ראוי להעמקה** | Connect4 מוסיף Executor/main thread, ביטול וזהות בקשה, transactions ותוצאה ישנה. Hex ממחיש תשובה שמגיעה אחרי Restart ואת פסילת רמז אחרי שינוי הלוח. להעמקה: תרגילי כשל עצמאיים וניתוח תחרות בפרויקט חדש | [מחשב ברקע ב־Connect4](/android/Connect4/06.connect4-background-turns/), [תרשים תשובה ישנה ב־Hex](/android/hex/06-background-ai/#background-flow), [בדיקת דור הרמז](/android/hex/08-hint/#show-hint-guard), [מהלכים מקבילים](/android/Connect4/11.connect4-online-game/), [התאוששות](/android/Connect4/12.connect4-online-recovery/) |
...
| אפיון, ארכיטקטורה, תיעוד והצגת פרויקט | **מוזכר/משלים** | ב־Hex יש מפת אחריות, תרשימי זרימה ושאלות הסבר על הארכיטקטורה שנבנית. עדיין חסרים תרגול עצמאי של דרישות בדיקות, יצירת תרשימי מסכים/מחלקות/נתונים, תיעוד החלטות, מדריך משתמש, ראיות בדיקה ורפלקציה | [מפת האחריות ב־Hex](/android/hex/#architecture), [שאלות שבוחן עשוי לשאול](/android/exam-prep/questions_tester_may_ask), [האקתון AI](/android/unsorted/habagrut) |
