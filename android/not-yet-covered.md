...
| אסינכרוניות ותחרות בין פעולות | **נלמד, ראוי להעמקה** | Connect4 מוסיף Executor/main thread, ביטול וזהות בקשה, transactions ותוצאה ישנה. להעמקה: תרגילי כשל עצמאיים וניתוח תחרות בפרויקט חדש | [מחשב ברקע](/android/Connect4/06.connect4-background-turns/), [מהלכים מקבילים](/android/Connect4/11.connect4-online-game/), [התאוששות](/android/Connect4/12.connect4-online-recovery/) |
