...
| אסינכרוניות ותחרות בין פעולות | **נלמד, ראוי להעמקה** | Connect4 מוסיף Executor/main thread, ביטול וזהות בקשה, transactions ותוצאה ישנה. Hex ממחיש בתרשים רצף תשובה שמגיעה אחרי Restart ואת בדיקת דור המשחק. להעמקה: תרגילי כשל עצמאיים וניתוח תחרות בפרויקט חדש | [מחשב ברקע ב־Connect4](/android/Connect4/06.connect4-background-turns/), [תרשים תשובה ישנה ב־Hex](/android/hex/06-background-ai/#background-flow), [מהלכים מקבילים](/android/Connect4/11.connect4-online-game/), [התאוששות](/android/Connect4/12.connect4-online-recovery/) |
